                                ...
                                >
                                    <thead class="bg-sky-500 text-white">
                                        <tr>
                                            ...
                                            <th
                                                class="px-6 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-center"
                                            >
                                                Published On
                                            </th>
                                            <th
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        ...
                                        >
                                            ...
                                            >
                                                <a
                                                  v-for="(list, i) in item.articles_authors"
                                                    v-bind:key="i"
                                                      :href="`/author/${list.id}/${list.author_name.replace(/ /g,'-' )}`"
                                                        class="text-sky-500"
                                                    @click.prevent="
                                                        author(
                                                            list.id,
...
export default {
    ...
    methods: {
        ...
        onPageChange(page) {
            ...
            axios
                .get(`/api/publication/view/${id}/${name}?page=${page}`)
                .then((res) => {
